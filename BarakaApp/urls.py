...
urlpatterns = [
    ...
    path('locations/', views.location_func.as_view(), name='location'),
    ...
    path('all_employees/<str:pk>/', views.allEmployeeView.as_view(), name='all-employees'),
    ...
    path('store/<str:pk>/', views.StoresViews.as_view(), name='store'),
    path('other-products/<str:pk>/', views.OtherProductsViews.as_view(), name=''),
    path('refill/', views.RefillOperations.as_view()),
    path('addnewcylinder/<str:pk>/', views.AddNewCylinder.as_view()),
    ...
    path('transfer/<str:employee_id>/', views.TransferEmployee.as_view()),
    ...
    path('monthly-salary/<str:pk>/', views.MonthlySalaryOperation.as_view()),
    path('monthly-salary/', views.MonthlySalaryOperation.as_view()),
    path('search-customer/', views.SearchCustomer.as_view()),
    path('deport-refill/', views.DeportRefillView.as_view()),
    path('deport-repair/', views.DeportRepairView.as_view()),
]